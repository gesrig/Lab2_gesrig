...
public class GalleryActivity extends AppCompatActivity {
    ...
    private String getPictureName() {
        String imageName = "GameImages" + timeStamp + ".jpg";
        return imageName;
    }
...
*/
                ...
                contentValues.put(DBHelper.COL_GAME_ID, game_id);
                contentValues.put(DBHelper.COL_IMAGE, byteArray);
                contentValues.put(DBHelper.COL_DATE1, iDate);
                contentValues.put(DBHelper.COL_URI, imageUri.toString());
                dbHelper.insertImageData(DBHelper.TABLE_IMAGES, contentValues);
    ...
    private void populateGridView() {
        String[] fields = new String[]{DBHelper.COL_IMAGE_ID, DBHelper.COL_IMAGE, DBHelper.COL_DATE1};
        String where = " game_id = ?";
        String[] args = new String[]{Integer.toString(game_id)};
        int[] items = new int[] {R.id.col_id, R.id.game_image, R.id.date_game};
